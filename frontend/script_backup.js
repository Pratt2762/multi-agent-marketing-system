...
function renderBudgetColumn(budgetActions, finalState) {
    ...
    console.log('Budget HTML length:', html.length);
    const budgetElement = document.getElementById('budget-recommendations');
    console.log('Budget element:', budgetElement);
    if (budgetElement) {
        budgetElement.innerHTML = html;
        console.log('Budget recommendations rendered successfully');
    } else {
        console.error('budget-recommendations element not found!');
    }
}
...
function loadResults() {
    ...
    fetch(RESULTS_FILE)
        ...
        .then(data => {
            ...
            // Render new sections
            console.log('Rendering action summary cards...');
            renderActionSummaryCards(finalRecommendations);

            console.log('Rendering three column recommendations...');
            renderThreeColumnRecommendations(finalRecommendations, finalState);

            console.log('Rendering AI explanation...');
